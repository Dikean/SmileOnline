   ...
   public function store(Request $request)
   {
    ...
    for($i=0; $i<7; ++$i){
        ...
        if($morning_start[$i] > $morning_end[$i]){
           $errors [] = 'Inconcsistencia en el intervalo de las horas del turno de la mañana del dia '.$this->days[$i].'.';
        }
        if($afternoon_end[$i] > $afternoon_end[$i]){
            $errors [] = 'Inconcsistencia en el intervalo de las horas del turno de la Tarde del dia '.$this->days[$i].'.';
         }
